...
//  Greedy Kings
//
//  Created by Suren Poghosyan on 19.10.23.
//
...
final class PauseViewController: UIViewController {
    ...
    private func setupButtonsStackView() {
        continueButton = createButton(buttonLabel: "Continue")
        ...
        buttonsStackView = UIStackView(arrangedSubviews: [continueButton, rematchButton, mainMenuButton])
    ...
    private func setupModal() {
        ...
        modalStackView = UIStackView(arrangedSubviews: [ buttonsStackView])
